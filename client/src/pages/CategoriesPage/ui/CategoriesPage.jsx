...
import { getIncomesCategories } from '../../../shared/http/incomesAPI';
import { MAKE_CATEGORY_ROUTE } from '../../../shared/utils/consts/consts';
...
const CategoriesPage = () => {
    ...
    useEffect(() => {
        getIncomesCategories()
            .then(data => setIncomesCategories(data))
    ...
    return (
        <div>
            ...
            <div onClick={() => navigate(MAKE_CATEGORY_ROUTE)} className={classNames(cls.Button, {}, [])}>
