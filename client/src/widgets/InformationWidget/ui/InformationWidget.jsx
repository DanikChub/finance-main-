...
const InformationWidget = ({setArrayDataWithPeriod, arrayDataWithPeriod, userId}) => {
    ...
    useEffect(() => {
        ...
        switch (periodActive) {
            case 'day':
                ...
                getIncomesByDate(userId, today, today)
            ...
            case 'week':
                ...
                getIncomesByDate(userId, today, result)
                .then(data => setArrayDataWithPeriod(data))
                .finally(data => setIsLoaded(true))
                break;
            case 'month':
    ...
    return (
        <div className={classNames(cls.InformationWidget, {}, [])}>
            ...
            </div>
            {
                isLoaded 
                ?      
                    <Canvas canvasHeight={220} canvasWidth={310} arrayDataWithPeriod={arrayDataWithPeriod}/>
                :
                    <CanvasLoader/>
